...
public class CigaretteSmoke : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (allPointsAdded)
		{
			Vector2 offset = new Vector2(lineSegment * (timeSinceUpdate / updateSpeed), 1f);
			lineMaterial.SetTextureOffset(lineMaterial.mainTexture.name, offset);
		}
	}
